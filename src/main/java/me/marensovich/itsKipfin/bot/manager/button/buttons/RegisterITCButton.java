...
public class RegisterITCButton implements Button {
    ...
    */
    ...
    public static class MediaHandler {
        ...
        /**
         * Запросить у пользователя ФИО и переключить шаг на {@link ProjectTeamHandler.Step#FULL_NAME}.
         * @author marensovich
         * @since 0.0.1
         */
        private void askFullName() {
        ...
        /**
         * Запросить номер телефона и переключить шаг на {@link ProjectTeamHandler.Step#PHONE_NUMBER}.
         * @author marensovich
         * @since 0.0.1
         */
        private void askPhoneNumber() {
